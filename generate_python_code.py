...
- If the code will live in this repo and needs to use the gpt() function, it should import it using `from gpt import gpt` and NOT ever say `chat = lmtk.modes.raw_gpt.RawGPTMode()`
